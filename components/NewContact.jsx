        ...
        <LowerContainerLeft>
          <OpenHours>
            ...
            <div className="hours-list">
              <div>
                <p className="open">Monday</p>
                <p>10 am - 8 pm</p>
              </div>
              <div>
                <p className="open">Tuesday</p>
                <p>10 am - 8 pm</p>
              </div>
              <div>
                <p className="open">Wednesday</p>
                <p>10 am - 8 pm</p>
              </div>
              <div>
                <p className="open">Thursday</p>
                <p>10 am - 8 pm</p>
              </div>
              <div>
                <p className="open">Friday</p>
                <p>10 am - 8 pm</p>
              </div>
              <div>
                <p className="open">Saturday</p>
                <p>Closed</p>
              </div>
              <div>
